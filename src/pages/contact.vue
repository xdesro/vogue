<template>
  <div class="layout layout--contact">
    ...
    <main class="main main--container" id="main" role="main">
      ...
      <ul class="contact__list contact-list">
        ...
        <li class="contact__list-item">
          <ul class="additional-links-list">
            <li class="additional-links-list__item" v-for="(link, index) in secondarySocialLinks" :key="index">
      ...
      <img class="contact__accent-img" src="~assets/img/illustration-02.svg" alt role="presentation" />
    </main>
  </div>
</template>
<script>
